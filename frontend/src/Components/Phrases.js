      ...
      <div className="flex flex-col justify-between h-140 w-full gap-1 border col-span-2 rounded-md pt-2 min-[400px] shadow-lg">
        ...
        >
          <form
            ...
            className="flex flex-row justify-between gap-6 font-serif max-[500px]:text-xs"
          >
            <div className="h-full w-fit flex items-center">
              ...
              <select
                name="level"
                id="level"
                className="bg-slate-100 border-2 border-slate-300 rounded p-1"
              >
            ...
            <div className="w-fit h-full flex items-center">
              <label htmlFor="level" className="mr-1 max-w-[400px]:text-sm ">
                # of practice
              </label>
              <select
                name="times"
